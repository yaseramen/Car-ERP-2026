...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.error) {
        setError(
          "لم ينجح تسجيل الدخول. تحقق من كلمة المرور والبريد، أو أن حسابك وشركتك مفعّلان. إن كنت متأكد من البيانات، قد تكون قاعدة البيانات غير متصلة — راجع TURSO في Vercel. مالك شركة: يمكن استخدام «نسيت كلمة المرور»."
        );
        setLoading(false);
        return;
      }
