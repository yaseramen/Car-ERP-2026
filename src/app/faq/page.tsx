...
export const metadata: Metadata = {
  title: "الأسئلة الشائعة | برنامج الأمين لإدارة مراكز الصيانة وقطع الغيار",
  description:
    "إجابات على الأسئلة الشائعة حول برنامج الأمين: التسجيل، التكلفة، المميزات، دعم مراكز الصيانة ومحلات قطع الغيار، الفواتير، المخزون، والورشة.",
  keywords: [
...
const FAQ_ITEMS = [
  {
    q: "ما هو برنامج الأمين؟",
    a: "برنامج الأمين منصة متكاملة لإدارة مراكز خدمة السيارات ومحلات بيع قطع الغيار. يتضمن إدارة المخزون، الفواتير، الورشة، الكاشير، العملاء، الموردين، والتقارير.",
  },
  {
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto py-12 px-6">
        ...
        <p className="text-gray-600 mb-12">
          إجابات على أكثر الأسئلة شيوعاً حول برنامج الأمين لإدارة مراكز الصيانة ومحلات قطع الغيار.
        </p>
