...
export const metadata: Metadata = {
  title: "كيف يعمل برنامج الأمين | إدارة مراكز الصيانة وقطع الغيار",
  description:
    "شرح مفصل لكيفية عمل برنامج الأمين لإدارة مراكز خدمة السيارات ومحلات قطع الغيار. خطوات التسجيل، إدارة المخزون، الورشة، الفواتير، والتقارير.",
  keywords: [
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto py-12 px-6">
        ...
        <p className="text-gray-600 mb-12">
          برنامج الأمين مصمم ليكون سهل الاستخدام. اتبع الخطوات التالية للبدء في إدارة مركزك أو محلّك.
        </p>
