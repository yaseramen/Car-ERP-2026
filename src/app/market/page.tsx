    ...
    <div className="min-h-screen bg-gray-50 text-gray-900" dir="rtl">
      <header className="border-b bg-white">
        <div className="max-w-5xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-bold text-emerald-800">سوق EFCT</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <div className="flex gap-2 mb-6 border-b border-gray-200">
          <Link
            ...
            className={`px-4 py-2 text-sm font-medium rounded-t-lg ${
              tab === "parts"
                ? "bg-white border border-b-0 border-gray-200 text-emerald-800"
        ...
        {listings.length === 0 ? (
          <p className="text-center text-gray-500 py-16">لا توجد عروض نشطة في هذا القسم حالياً.</p>
        ) : (
            ...
            {listings.map((l) => (
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <h2 className="font-bold text-gray-900 mt-1">{l.title_ar}</h2>
                  {l.description_ar && (
                    <p className="text-sm text-gray-600 mt-2 line-clamp-3">{l.description_ar}</p>
                  )}
                  {l.list_price != null && (
                  ...
                  <div className="mt-auto pt-4 space-y-1 text-sm border-t border-gray-100">
                    <p>
                      <span className="text-gray-500">هاتف: </span>
                      <a href={`tel:${l.contact_phone}`} className="text-emerald-700 font-medium dir-ltr inline-block">
                        {l.contact_phone}
                      </a>
                    </p>
                    {l.contact_whatsapp && (
